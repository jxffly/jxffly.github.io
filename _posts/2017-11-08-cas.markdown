...
参考文档:<http://zl198751.iteye.com/blog/1848575>
...
>
> ​    return [unsafe.compareAndSwapInt(this](http://unsafe.compareAndSwapInt(this), valueOffset, expect, update);
>
> ​    }
...
[unsafe.compareAndSwapInt(this](http://unsafe.compareAndSwapInt(this), valueOffset, expect, update);
